        ...
        <div className="row mt-4">
          ...
          <div className="col-lg-4 col-md-6 mb-4 mb-md-0">
            ...
            <ul className="fa-ul" style={{ "marginLeft": "1.65em" }}>
              <li className="mb-3">
                <span className="fa-li"><i className="fa fa-home"></i></span> <a href='https://www.google.com/maps/place/Romantiko+Barber+Shop/@51.2911508,-114.0028717,338m/data=!3m1!1e3!4m6!3m5!1s0x53715f25208d2603:0xe5655ce1b5340234!8m2!3d51.2910039!4d-114.0030376!16s%2Fg%2F11qgyl2v4v'> <span className="ms-1">513 Centre Ave E #125, Airdrie, AB T4B 1P9</span> </a>
              </li>
              <li className="mb-3">
